...
This redesign organizes the information on the original graphic in a way that makes comparisons between subcategories easier. It is immediately clear when looking at this graph what the largest and smallest sources of emissions are and how the other subcategories rank between them. This design also eases comparisons between sectors. For example, it is easy to see that “Passenger Vehicles,” a subcategory of Transportation, accounts for the highest percentage of emissions, followed by “In-State Generation,” a subcategory of Electricity. This is a more useful way to present the data than the original visualization, as it gives better insight into the most efficient allocation of resources to reduce GHG emissions.
...
A line plot showing how emissions from each sector or some of the larger subcategories have changed over time
